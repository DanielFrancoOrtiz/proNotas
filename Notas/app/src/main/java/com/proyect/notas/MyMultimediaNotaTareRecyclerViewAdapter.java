 ...
 */
public class MyMultimediaNotaTareRecyclerViewAdapter extends RecyclerView.Adapter<MyMultimediaNotaTareRecyclerViewAdapter.ViewHolder> {

    private final List<FotoVideoAudio> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyMultimediaNotaTareRecyclerViewAdapter(List<FotoVideoAudio> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_multimedianotatare, parent, false);
